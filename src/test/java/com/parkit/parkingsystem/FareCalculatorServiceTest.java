...
public class FareCalculatorServiceTest {
    ...
    public void calculateFareCarWithDiscountDescription() {
        ...
        Date inTime = new Date();
        inTime.setTime(System.currentTimeMillis() - (20 * 60 * 60 * 1000));
        ...
        assertEquals((20 * Fare.CAR_RATE_PER_HOUR) * 0.95, ticket.getPrice());
    ...
    public void calculateFareBikeWithDiscountDescription() {
        ...
        assertEquals((20 * Fare.BIKE_RATE_PER_HOUR) * 0.95, ticket.getPrice());
